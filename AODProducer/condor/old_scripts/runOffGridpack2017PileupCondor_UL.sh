...
do
    ...
    cmsDriver.py Configuration/GenProduction/python/${HADRONIZER}_ctau-${ctau_mm}.py \
        ...
        --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeVEarly2017Collision \
    ...
    cmsDriver.py step2 \
        ...
        --conditions 106X_mcRun2_asymptotic_v13 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI \

...
xrdcp root://cmseos.fnal.gov//store/group/lpcmetx/iDMe//compiled_CMSSW_envs/reMini_lowptIDNoCut.tar.gz .
tar -xzf reMini_lowptIDNoCut.tar.gz
...
do
    ...
    sed -i -e "s|NTHREAD|${nThread}|g" miniRun.py
    cmsRun miniRun.py

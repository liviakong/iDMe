...
do
	...
	condor_submit reMiniAOD_config.jdl -append "Arguments = ${sublist_name} ${outCollName} ${nThreads}" -append "transfer_input_files = ${sublist_full},${config}" -append "request_cpus = ${nThreads}"
done

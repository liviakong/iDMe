...
# with command line options: step1 -s PAT --runUnscheduled --data --era Run2_2018,pf_badHcalMitigation --scenario pp --conditions 106X_dataRun2_v37 --eventcontent MINIAOD --datatier MINIAOD --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2018,Configuration/DataProcessing/Utils.addMonitoring --filein file:test.root --python_filename=Data_miniAOD_UL18.py --no_exec
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run2_2018_cff import Run2_2018
from Configuration.Eras.Modifier_pf_badHcalMitigation_cff import pf_badHcalMitigation

process = cms.Process('PAT',Run2_2018,pf_badHcalMitigation)

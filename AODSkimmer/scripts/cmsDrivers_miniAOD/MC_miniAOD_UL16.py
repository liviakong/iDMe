...
# with command line options: step1 --no_exec --mc --python_filename MC_miniAOD_UL16.py --fileout MiniAOD.root --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --geometry DB:Extended --step PAT --conditions 106X_mcRun2_asymptotic_v17 --procModifiers run2_miniAOD_UL --era Run2_2016

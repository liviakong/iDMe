...
# with command line options: step1 -s PAT --runUnscheduled --data --era Run2_2017 --scenario pp --conditions 106X_dataRun2_v37 --eventcontent MINIAOD --datatier MINIAOD --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2017,Configuration/DataProcessing/Utils.addMonitoring --filein test.root --python_filename=Data_miniAOD_UL17.py --no_exec

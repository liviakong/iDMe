...
# with command line options: step1 --no_exec --mc --python_filename MC_miniAOD_UL18.py --fileout MiniAOD.root --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --geometry DB:Extended --step PAT --conditions 106X_upgrade2018_realistic_v16_L1v1 --procModifiers run2_miniAOD_UL --era Run2_2018

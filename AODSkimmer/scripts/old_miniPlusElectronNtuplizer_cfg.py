...
# import extra low-pT electron stuff from nanoAOD sequence
#from PhysicsTools.NanoAOD.lowPtElectrons_cff import lowPtElectronSequence as lowPtElectronSequenceNanoAOD
ntupleProcess.load('PhysicsTools.NanoAOD.lowPtElectrons_cff')

ntupleProcess.totalPath = cms.Path(ntupleProcess.egammaPostRecoSeq + ntupleProcess.lowPtElectronSequence + ntupleProcess.ntuples)

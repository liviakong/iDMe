...
def fillHistos(events,h,samp,cut,info,sum_wgt=1):
    ...
    if info["type"] == "signal":
        ...
        h.fill("match_ele_pt",IDtype='dR',match_type='Both',passID=match_both_passID,pt=match_both.pt,weight=1)
        h.fill("match_ele_eta",IDtype='dR',match_type='Both',passID=match_both_passID,eta=match_both.eta,weight=1)
        h.fill("match_ele_phi",IDtype='dR',match_type='Both',passID=match_both_passID,phi=match_both.phi,weight=1)
        h.fill("match_ele_dxy",IDtype='dR',match_type='Both',passID=match_both_passID,dxy=match_both.dxy,weight=1)
        h.fill("match_ele_dxySignif",IDtype='dR',match_type='Both',passID=match_both_passID,signif=match_both.dxy/match_both.dxyErr,weight=1)
        h.fill("match_ele_trkChi2",IDtype='dR',match_type='Both',passID=match_both_passID,chi2=match_both.trkChi2,weight=1)
        h.fill("match_ele_trkProb",IDtype='dR',match_type='Both',passID=match_both_passID,prob=match_both.trkProb)
        h.fill("match_ele_trkRelIso",IDtype='dR',match_type='Both',passID=match_both_passID,iso=match_both.trkRelIso,weight=1)
        h.fill("match_ele_calRelIso",IDtype='dR',match_type='Both',passID=match_both_passID,iso=match_both.calRelIso,weight=1)
        h.fill("match_ele_PFRelIso",IDtype='dR',match_type='Both',passID=match_both_passID,iso=match_both.PFRelIso,weight=1)
        h.fill("match_ele_miniRelIso",IDtype='dR',match_type='Both',passID=match_both_passID,iso=match_both.miniRelIso,weight=1)
        h.fill("match_ele_mindRJets",IDtype='dR',match_type='Both',passID=match_both_passID,dR=match_both.mindRj,weight=1)
        h.fill("match_ele_mindPhiJets",IDtype='dR',match_type='Both',passID=match_both_passID,phi=match_both.mindPhiJ,weight=1)
        h.fill('match_ele_isPF',IDtype='dR',match_type='Both',passID=match_both_passID,isPF=ak.values_astype(match_both.isPF,int),weight=1)
        h.fill('match_ele_numTrkHits',IDtype='dR',match_type='Both',passID=match_both_passID,numHits=match_both.numTrackerHits,weight=1)
        h.fill('match_ele_numPixHits',IDtype='dR',match_type='Both',passID=match_both_passID,numHits=match_both.numPixHits,weight=1)
        h.fill('match_ele_numStripHits',IDtype='dR',match_type='Both',passID=match_both_passID,numHits=match_both.numStripHits,weight=1)
        h.fill("match_ele_sigmaIetaIeta",IDtype='dR',match_type='Both',passID=match_both_passID,sieie=match_both.full55sigmaIetaIeta,weight=1)
        h.fill("match_ele_absdEtaSeed",IDtype='dR',match_type='Both',passID=match_both_passID,detaSeed=match_both.absdEtaSeed,weight=1)
        h.fill("match_ele_absdPhiIn",IDtype='dR',match_type='Both',passID=match_both_passID,phi=match_both.absdPhiIn,weight=1)
        h.fill("match_ele_HOverE",IDtype='dR',match_type='Both',passID=match_both_passID,hoe=match_both.HoverE,weight=1)
        h.fill("match_ele_1E1p",IDtype='dR',match_type='Both',passID=match_both_passID,emp=match_both.abs1overEm1overP,weight=1)
        h.fill("match_ele_expMissing",IDtype='dR',match_type='Both',passID=match_both_passID,missing=match_both.expMissingInnerHits,weight=1)
        h.fill("match_ele_passConvVeto",IDtype='dR',match_type='Both',passID=match_both_passID,passVeto=match_both.conversionVeto,weight=1)
        h.fill("match_ele_IDscore",IDtype='dR',match_type='Both',passID=match_both_passID,id=match_both.IDscore,weight=1)
        ...
        h.fill("match_ele_gen_pt",IDtype='dR',match_type='Both',passID=match_both_passID,pt=genObj_both.pt,weight=1)
        h.fill("match_ele_gen_vxy1",IDtype='dR',match_type='Both',passID=match_both_passID,vxy=genObj_both.vxy,weight=1)
        h.fill("match_ele_gen_vxy10",IDtype='dR',match_type='Both',passID=match_both_passID,vxy=genObj_both.vxy,weight=1)
        h.fill("match_ele_gen_vxy100",IDtype='dR',match_type='Both',passID=match_both_passID,vxy=genObj_both.vxy,weight=1)
        h.fill('match_ele_gen_pt_dRbin_vxybin',IDtype='dR',match_type='Both',passID=match_both_passID,pt=genObj_both.pt,dRCat=genObj_both.dRbin,vxyCat=genObj_both.vxyBin)
        h.fill('match_ele_gen_dR_ptbin_vxybin',IDtype='dR',match_type='Both',passID=match_both_passID,dR=genObj_both.dr,ptCat=genObj_both.ptBin,vxyCat=genObj_both.vxyBin)
        h.fill('match_ele_gen_vxy1_dRbin_ptbin',IDtype='dR',match_type='Both',passID=match_both_passID,vxy=genObj_both.vxy,dRCat=genObj_both.dRbin,ptCat=genObj_both.ptBin)
        h.fill('match_ele_gen_vxy10_dRbin_ptbin',IDtype='dR',match_type='Both',passID=match_both_passID,vxy=genObj_both.vxy,dRCat=genObj_both.dRbin,ptCat=genObj_both.ptBin)
        h.fill('match_ele_gen_vxy100_dRbin_ptbin',IDtype='dR',match_type='Both',passID=match_both_passID,vxy=genObj_both.vxy,dRCat=genObj_both.dRbin,ptCat=genObj_both.ptBin)
        h.fill("match_ele_gen_eta",IDtype='dR',match_type='Both',passID=match_both_passID,eta=genObj_both.eta,weight=1)
        h.fill("match_ele_gen_phi",IDtype='dR',match_type='Both',passID=match_both_passID,phi=genObj_both.phi,weight=1)
        h.fill("match_ele_gen_dR",IDtype='dR',match_type='Both',passID=match_both_passID,dR=genObj_both.dr,weight=1)
        h.fill("match_ele_ptRes",IDtype='dR',match_type='Both',passID=match_both_passID,ptres=(genObj_both.pt-match_both.pt)/genObj_both.pt,weight=1)
        ...
        h.fill("match_ele_pt",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,pt=match_both.pt,weight=1)
        h.fill("match_ele_eta",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,eta=match_both.eta,weight=1)
        h.fill("match_ele_phi",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,phi=match_both.phi,weight=1)
        h.fill("match_ele_dxy",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,dxy=match_both.dxy,weight=1)
        h.fill("match_ele_dxySignif",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,signif=match_both.dxy/match_both.dxyErr,weight=1)
        h.fill("match_ele_trkChi2",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,chi2=match_both.trkChi2,weight=1)
        h.fill("match_ele_trkProb",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,prob=match_both.trkProb)
        h.fill("match_ele_trkRelIso",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,iso=match_both.trkRelIso,weight=1)
        h.fill("match_ele_calRelIso",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,iso=match_both.calRelIso,weight=1)
        h.fill("match_ele_PFRelIso",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,iso=match_both.PFRelIso,weight=1)
        h.fill("match_ele_miniRelIso",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,iso=match_both.miniRelIso,weight=1)
        h.fill("match_ele_mindRJets",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,dR=match_both.mindRj,weight=1)
        h.fill("match_ele_mindPhiJets",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,phi=match_both.mindPhiJ,weight=1)
        h.fill('match_ele_isPF',IDtype='Base',match_type='Both',passID=match_both_passIDBasic,isPF=ak.values_astype(match_both.isPF,int),weight=1)
        h.fill('match_ele_numTrkHits',IDtype='Base',match_type='Both',passID=match_both_passIDBasic,numHits=match_both.numTrackerHits,weight=1)
        h.fill('match_ele_numPixHits',IDtype='Base',match_type='Both',passID=match_both_passIDBasic,numHits=match_both.numPixHits,weight=1)
        h.fill('match_ele_numStripHits',IDtype='Base',match_type='Both',passID=match_both_passIDBasic,numHits=match_both.numStripHits,weight=1)
        h.fill("match_ele_sigmaIetaIeta",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,sieie=match_both.full55sigmaIetaIeta,weight=1)
        h.fill("match_ele_absdEtaSeed",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,detaSeed=match_both.absdEtaSeed,weight=1)
        h.fill("match_ele_absdPhiIn",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,phi=match_both.absdPhiIn,weight=1)
        h.fill("match_ele_HOverE",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,hoe=match_both.HoverE,weight=1)
        h.fill("match_ele_1E1p",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,emp=match_both.abs1overEm1overP,weight=1)
        h.fill("match_ele_expMissing",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,missing=match_both.expMissingInnerHits,weight=1)
        h.fill("match_ele_passConvVeto",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,passVeto=match_both.conversionVeto,weight=1)
        h.fill("match_ele_IDscore",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,id=match_both.IDscore,weight=1)
        ...
        h.fill("match_ele_gen_pt",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,pt=genObj_both.pt,weight=1)
        h.fill("match_ele_gen_vxy1",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,vxy=genObj_both.vxy,weight=1)
        h.fill("match_ele_gen_vxy10",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,vxy=genObj_both.vxy,weight=1)
        h.fill("match_ele_gen_vxy100",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,vxy=genObj_both.vxy,weight=1)
        h.fill('match_ele_gen_pt_dRbin_vxybin',IDtype='Base',match_type='Both',passID=match_both_passIDBasic,pt=genObj_both.pt,dRCat=genObj_both.dRbin,vxyCat=genObj_both.vxyBin)
        h.fill('match_ele_gen_dR_ptbin_vxybin',IDtype='Base',match_type='Both',passID=match_both_passIDBasic,dR=genObj_both.dr,ptCat=genObj_both.ptBin,vxyCat=genObj_both.vxyBin)
        h.fill('match_ele_gen_vxy1_dRbin_ptbin',IDtype='Base',match_type='Both',passID=match_both_passIDBasic,vxy=genObj_both.vxy,dRCat=genObj_both.dRbin,ptCat=genObj_both.ptBin)
        h.fill('match_ele_gen_vxy10_dRbin_ptbin',IDtype='Base',match_type='Both',passID=match_both_passIDBasic,vxy=genObj_both.vxy,dRCat=genObj_both.dRbin,ptCat=genObj_both.ptBin)
        h.fill('match_ele_gen_vxy100_dRbin_ptbin',IDtype='Base',match_type='Both',passID=match_both_passIDBasic,vxy=genObj_both.vxy,dRCat=genObj_both.dRbin,ptCat=genObj_both.ptBin)
        h.fill("match_ele_gen_eta",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,eta=genObj_both.eta,weight=1)
        h.fill("match_ele_gen_phi",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,phi=genObj_both.phi,weight=1)
        h.fill("match_ele_gen_dR",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,dR=genObj_both.dr,weight=1)
        h.fill("match_ele_ptRes",IDtype='Base',match_type='Both',passID=match_both_passIDBasic,ptres=(genObj_both.pt-match_both.pt)/genObj_both.pt,weight=1)
